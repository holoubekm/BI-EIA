...
int rekmy(int i, int fr_cap, int price)
{
	...
	if(fr_cap - array_of_items[i].weight >= 0) {
		if(i < no_items)
			rekmy(i + 1, fr_cap - array_of_items[i].weight, price + array_of_items[i].cost);

		if(i == no_items - 1 && price + array_of_items[i].cost > tmp_max) {
			tmp_max = price + array_of_items[i].cost;
			max_state[i] = 1;
		}
	}
...
int main(void) {
	...
	do {
		...
		// array_of_items[0].cost = 45;
		// array_of_items[0].weight = 3;
		// array_of_items[1].cost = 30;
		// array_of_items[1].weight = 5;
		// array_of_items[2].cost = 45;
		// array_of_items[2].weight = 9;
		// array_of_items[3].cost = 10;
		// array_of_items[3].weight = 5;
		// no_items = 4;
		// capacity = 16;
		// reset computation
		tmp_max = -1;
